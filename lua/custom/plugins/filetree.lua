...
-- NESTING_RULES {{{
-- Taken from github/saufulapm/neotree-file-nesting-config
-- https://github.com/saifulapm/neotree-file-nesting-config/blob/089adb6d3e478771f4485be96128796fb01a20c4/lua/neotree-file-nesting-config.lua
local nesting_rules = {
  ['*.asax'] = {
    files = { '%1%.*%.cs', '%1%.*%.vb' },
    pattern = '(.*)%.asax$'
