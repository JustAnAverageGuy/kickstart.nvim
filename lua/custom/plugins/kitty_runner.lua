  ...
  keys = {
    {
      ...
      function()
        ...
        local command = string.format(
          ...
          vim.fn.shellescape(vim.fn.expand('%:p'), 'yes') -- note, for some reason doesn't quote quotes properly TODO: investingate, maybe due to kitty's internal quoting mechanism
        )
